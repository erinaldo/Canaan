...
namespace CPanel.Dados
{
    ...
    public partial class metas_fotografados
    {
        public int id_meta_fotografado { get; set; }
        ...
        public Nullable<int> meta_semanal { get; set; }
        public Nullable<int> total_alcancado { get; set; }
