...
namespace Canaan.Relatorios.Concurso.BabyShow
{
    public partial class Viewer : Form
    {
        ...
        private void CarregaDados()
        {
            ...
            rw.CliDocumento = !string.IsNullOrEmpty(Cliente.Documento) ? string.Format(@"{0:000\.000\.000\-00}", Convert.ToInt64(Cliente.Documento)) : "";
