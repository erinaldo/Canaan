...
namespace Canaan.Telas.Financeiro.Agencia
{
    public partial class Lista : FormLista
    {
        ...
        public List<Dados.Agencia> objLista { get; set; }
        ...
        public Lista(int idBanco)
        {
            //inicializa propriedades
            objLib = new Lib.Agencia();
            objLista = objLib.GetByBanco(idBanco);
        ...
        private void btnExecFiltro_Click(object sender, EventArgs e)
        {
            ...
            FilterExpression = objLibFiltro.GetByNome(filterName, typeof(Dados.Agencia).FullName, Session.Instance.Usuario.IdUsuario);
        ...
        private void btnFiltros_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var frm = new FormFilterBase(typeof(Dados.Agencia));
                frm.ShowDialog();
        ...
        private void btnContas_Click(object sender, EventArgs e)
        {
            if (dataGrid.SelectedRows.Count > 0)
            {
                ...
                Conta.Lista frm = new Conta.Lista(Id);
                frm.ShowDialog();
            }
            else
            {
        ...
        {
            btnActions.DropDownItems.Add(new ToolStripMenuItem("Contas Bancárias", null, new EventHandler(btnContas_Click)));
        }

        protected override void CarregaFiltros()
        {
            // Carrega Lista de Filtros para a entidade atual
            var filtros = objLibFiltro.GetByEntidade(typeof(Dados.Agencia).FullName, Session.Instance.Usuario.IdUsuario);
