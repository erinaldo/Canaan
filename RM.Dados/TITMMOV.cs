...
namespace RM.Dados
{
    ...
    public partial class TITMMOV
    {
        ...
        public Nullable<int> IDCNTOP { get; set; }
        public Nullable<decimal> QUANTIDADECONCLUIDA { get; set; }
        public Nullable<System.DateTime> DATAFATCONTRATO { get; set; }
        ...
        public virtual TPRODUTO TPRODUTO1 { get; set; }
        public virtual TITMMOVCOMPL TITMMOVCOMPL { get; set; }
