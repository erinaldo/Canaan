...
namespace RM.Relatorios.Entradas.ParcialGerente
{
    public partial class Filtro : Form
    {
        ...
        private void CarregaGerentes()
        {
            ...
            List<Dados.TVEN> gerentes = Lib.Vendedora.GetByFilial(Filial.CODCOLIGADA, Filial.CODFILIAL).Where(a => a.VENDECOMPRA == (short)Lib.Enums.Funcoes.Gerente).ToList();
        ...
        private List<Model> GetResult()
        {
            ...
            List<Dados.FLAN> lancamentos = Lib.Lancamento.GetParcialByFilial(filial);
